...
class Constants {
  ...
  static const Color blueGeneric = Color.fromARGB(255, 188, 95, 95);

  static const String apiUrl = '192.168.0.11:8081';
...
List<DropdownMenuItem<String>> get dropdownCurrentJobItems {
  List<DropdownMenuItem<String>> menuItems = const [
    ...
    DropdownMenuItem(child: Text("Mas de 5 años"), value: "4"),
  ];
  return menuItems;
}
...
List<DropdownMenuItem<String>> get dropdownStudyGradeItems {
  List<DropdownMenuItem<String>> menuItems = const [
    ...
    DropdownMenuItem(child: Text("Universidad"), value: "4"),
  ];
  return menuItems;
}
